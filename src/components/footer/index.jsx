...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="grid gap-10 bg-orangePeel">
        <img
          src={claystonetextLogo}
          className="w-[449px] h-[64px] object-contain"
      ...
      <div class="bg-orangePeel p-4">Larger Width 2</div>

      <div class="bg-gradientStart p-4">Smaller Width 1</div>
      <div class="bg-orangePeel p-4">Smaller Width 2</div>
    </div> */}
        ...
        <div class="lg:flex lg:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div className="grid gap-4">
              <h2 className="font-poppins font-semibold text-[32px] text-white leading-[40px]">
                Explore
              </h2>
